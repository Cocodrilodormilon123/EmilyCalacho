...
class AdminReservaUpdateState extends Equatable {
  final int? id; // ID de la reserva a actualizar
  ...
  // Convierte el estado a Reserva para actualizar
  Reserva toReserva() => Reserva(
    idreserva: id, // IMPORTANTE: Incluye el ID para actualizar
  ...
  AdminReservaUpdateState copyWith({
    int? id,
    ...
    return AdminReservaUpdateState(
      id: id ?? this.id,
